...
<body class="min-h-screen flex items-center justify-center bg-offwhite-100">
    ...
    <img src="./media/pagepic.png" class="w-full h-full object-cover">
        ...
        <div class="w-full md:w-1/2 max-w-md p-8 flex flex-col justify-center mx-auto md:order-1">
            ...
            <form action="login_validate.php" method="POST" class="space-y-4">
                <div>
                    <label class="block text-sm font-medium text-offblack-100 mb-1">Email Address</label>
                    <input type="email" name="email" required placeholder="Enter email address" class="bg-white w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400">
                </div>
                <div>
                    <label class="block text-sm font-medium text-offblack-100 mb-1">Password</label>
                    <input type="password" name="password" required placeholder="Enter password" class="bg-white w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400">
                </div>
                <?php
                ...
                <?php
                    ...
                    <div class="border-red-300 border bg-red-100 p-3 text-center mt-2 text-red-400 rounded-md flex items-center justify-center">
                        <img src="./media/circle-exclamation-solid-full.svg" alt="Info" class="size-5 filter-red"><p>&nbsp;You must login first to proceed.</p>
                    </div>
                <?php } ?>
                <div>
