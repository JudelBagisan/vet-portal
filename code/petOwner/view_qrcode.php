...
$idLogin = $_SESSION['idLogin'];
    $query = "SELECT qr_code FROM petsappointment WHERE appointmentId = ?";
    if ($stmt = $conn->prepare($query)) {
        ...
        if ($stmt->execute()) {
            ...
            if ($result->num_rows > 0) {
                ...
                die("No QR code found for the given appointment ID.");
            }
        } else {
...
<style>
  ...
  <div class="flex flex-col">
    ...
    <div class="flex flex-col gap-3 mt-20">
      ...
      <a href="clinic_list.html" class="flex items-center rounded-md hover:bg-lightgrey-100 hover:cursor-pointer hover:text-blue-500 p-3 nav-item">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
      ...
      <a href="pet_list.html" class="flex items-center rounded-md hover:bg-lightgrey-100 hover:cursor-pointer hover:text-blue-500 p-3 nav-active">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
      ...
      <a href="appointment_list.html" class="flex items-center rounded-md hover:bg-lightgrey-100 hover:cursor-pointer hover:text-blue-500 p-3 nav-item">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
      ...
      <a href="history.html" class="flex items-center rounded-md hover:bg-lightgrey-100 hover:cursor-pointer hover:text-blue-500 p-3 nav-item">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
    ...
    <a href="logout.html" class="flex items-center rounded-md hover:bg-lightgrey-100 hover:cursor-pointer mt-20 hover:text-blue-500 p-3 nav-item">
...
<div class="flex flex-col justify-center items-center h-screen">
    <div class="text-offblack-100 flex flex-col items-center md:w-[40%] w-[80%] shadow-md rounded-xl p-5">
        <img  src="<?php echo htmlspecialchars($pet['qr_code']); ?>" alt="Pet QR Code"  id="image_url" class="w-[60%]">
        <h1 class="text-grey-100">Please Show this QR code to the clinic you've appointed.</h1>
        <button class="bg-green-800 text-white border-0 px-4 py-2 mt-2 rounded-md">Download QR</button>
   
        <a href="appointment_list.php" class="p-2 text-red-400">Close</a>
    </div>
</div>
